...
export default function DirectInviteModal({ familyId, onClose, onSuccess }: DirectInviteModalProps) {
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Invite someone to join your family space. They'll be able to create an account and contribute to your family history.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSendInvite} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select value={role} onValueChange={(value: 'member' | 'guest') => setRole(value)}>
                      ...
                      <SelectContent>
                        <SelectItem value="member">Member - Can add and edit content</SelectItem>
                        <SelectItem value="guest">Guest - Read-only access</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>

...
const blockTitles: Record<string, string> = {
  ...
  audio_remembrances: 'Audio Remembrances',
  voice_notes: 'Voice Notes',
  photos: 'Photos',
  photo_gallery: 'Photo Gallery',
  people_web: 'Family Connections',
  relationships: 'Relationships',
  guestbook_live: 'Guestbook',
  notes_from_friends: 'Notes from Friends',
  guestbook_tribute: 'Tribute Messages',
  service_events: 'Service & Events',
  events: 'Events',
  objects_places: 'Places & Objects',
  now_next: 'Now & Next',
  letters_time_capsule: 'Letters & Time Capsule',
  favorites_quirks: 'Favorites & Quirks',

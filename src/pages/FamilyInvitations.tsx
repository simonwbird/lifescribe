...
import { MagicLinkCreator } from '@/components/invites/MagicLinkCreator'
import { MagicLinkManager } from '@/components/invites/MagicLinkManager'
                  ...
                  <Card>
                    <CardContent className="py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full" />
                        <p className="text-sm text-muted-foreground">
                          Only administrators can create magic links.
                        </p>
                      </div>
                    </CardContent>
                  </Card>

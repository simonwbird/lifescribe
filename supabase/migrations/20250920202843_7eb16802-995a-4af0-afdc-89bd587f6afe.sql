-- First drop the existing views, then recreate them with proper security constraints
DROP VIEW IF EXISTS public.family_member_profiles;
DROP VIEW IF EXISTS public.invites_masked;

-- Create secure family_member_profiles view with security barrier
...
-- Create secure invites_masked view with security barrier and masked emails

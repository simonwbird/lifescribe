...
create policy "Family members can view media objects"
on storage.objects
for select
using (
  bucket_id = 'media'
...
create policy "Users can upload to their folder under family"
on storage.objects
for insert
with check (
  bucket_id = 'media'
...
-- Update own objects
create policy "Object owner can update media"
on storage.objects
for update
using (
  bucket_id = 'media'
...
-- Delete own objects
create policy "Object owner can delete media"
on storage.objects
for delete
using (
  bucket_id = 'media'

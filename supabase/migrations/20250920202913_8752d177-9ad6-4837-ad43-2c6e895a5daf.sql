-- Secure views by dropping and recreating with proper column ordering
-- Views cannot have RLS directly, but we can secure them with security_barrier and proper filtering

-- Drop existing views to recreate them securely

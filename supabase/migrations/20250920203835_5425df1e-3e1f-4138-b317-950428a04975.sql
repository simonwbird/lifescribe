-- Fix person_timeline_items view to inline auth queries and remove SECURITY DEFINER dependency
DROP VIEW IF EXISTS public.person_timeline_items CASCADE;

-- Recreate person_timeline_items without any SECURITY DEFINER function calls
